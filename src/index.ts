...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .copy-id-btn svg { pointer-events: none; display: block; width: 14px; height: 14px; stroke: currentColor; }
