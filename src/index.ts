  ...
  return '<div class="task-card" data-id="' + t.id + '" data-status="' + t.status + '" data-assignee="' + (t.assigneeUserId || '') + '" data-project="' + (t.projectId || '') + '" data-future="' + (isFuture ? 'true' : 'false') + '" data-created="' + new Date(t.createdAt).getTime() + '" data-updated="' + new Date(t.updatedAt).getTime() + '" data-sort-key="' + (t.sortKey || 0) + '" onclick="toggleTaskExpand(this)">' +
    ...
    '<div class="task-content">' +
      ...
      '<div class="task-detail" onclick="event.stopPropagation()">' +
        ...
        (t.issueUrl ? '<div class="task-detail-row"><span class="task-detail-label"></span><span style="display:flex;align-items:center;gap:8px;"><a href="' + escapeHtml(t.issueUrl) + '" target="_blank" rel="noopener" ondblclick="window.open(this.href,\'_blank\')" style="color:var(--primary);font-size:0.8rem;">Open issue →</a><button onclick="event.preventDefault();copyUrl(\'' + escapeHtml(t.issueUrl).replace(/'/g, "\\'") + '\', this)" style="background:none;border:none;cursor:pointer;color:var(--muted-foreground);padding:4px;display:inline-flex;align-items:center;" title="Copy URL"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg></button></span></div>' : '') +
  ...
  <div class="project-drawer" id="projectDrawer">
    ...
    <div class="project-drawer-body">
      ...
      <div style="display:flex;gap:8px;align-items:center;margin-bottom:16px;">
        ...
        <a id="editProjectRepoLink" href="#" target="_blank" rel="noopener" ondblclick="window.open(this.href,'_blank')" style="display:none;background:none;border:1px solid var(--border);border-radius:var(--radius);color:var(--muted-foreground);padding:8px;text-decoration:none;" title="Open URL"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg></a>
      </div>
      ...
      <div style="display:flex;gap:8px;align-items:center;margin-bottom:16px;">
        ...
        <a id="editProjectDeployLink" href="#" target="_blank" rel="noopener" ondblclick="window.open(this.href,'_blank')" style="display:none;background:none;border:1px solid var(--border);border-radius:var(--radius);color:var(--muted-foreground);padding:8px;text-decoration:none;" title="Open URL"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg></a>
      </div>
    </div>
