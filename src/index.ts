...
<body>
  ...
  <script>
    ...
    const avatarData = {
      chris: 'data:image/jpeg;base64,',
      clio: 'data:image/png;base64,',
      domingo: 'data:image/jpeg;base64,',
      zumie: 'data:image/png;base64,',
    };
