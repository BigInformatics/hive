...
const sseTokens = new Map<string, { identity: string; isAdmin: boolean; expiresAt: number }>();
...
export function validateSseToken(token: string): { identity: string; isAdmin: boolean } | null {
